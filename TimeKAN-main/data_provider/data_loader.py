...
class Dataset_BatterySOH(Dataset):
    ...
    def __read_data__(self):
        ...
        df_cycle_capacity = df_raw.iloc[:, :2].copy()
        df_cycle_capacity.columns = ['cycle', 'capacity']
        df_cycle_capacity['soh'] = df_cycle_capacity['capacity'] / df_cycle_capacity['capacity'].iloc[0]

        data = df_cycle_capacity[['soh']].values
